...
<div class="d-flex justify-content-end align-items-center">
    @if(!$handyman->trashed())
        ...
        <a class="mr-2" href="{{ route('handyman.create',['id' => $handyman->id]) }}" title="{{ __('messages.update_form_title',['form' => __('messages.handyman') ]) }}"><i class="fas fa-pen text-primary"></i></a>
        @endif
