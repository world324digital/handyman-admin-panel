...
<div class="d-flex justify-content-end align-items-center">
    ...
    @if($auth_user->can('providertype edit'))
        <a class="mr-2" href="{{ route('providertype.create',['id' => $providertype->id]) }}" title="{{ __('messages.update_form_title',['form' => __('messages.providertype') ]) }}"><i class="fas fa-pen text-primary"></i></a>
    @endif
