...
<div class="d-flex justify-content-end align-items-center">
    @if(!$handymantype->trashed())
        @if(auth()->user()->hasRole(['provider','admin']) )
            <a class="mr-2" href="{{ route('handymantype.create',['id' => $handymantype->id]) }}" title="{{ __('messages.update_form_title',['form' => __('messages.handymantype') ]) }}"><i class="fas fa-pen text-primary"></i></a>
