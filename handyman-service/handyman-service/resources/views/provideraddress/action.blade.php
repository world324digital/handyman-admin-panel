...
<div class="d-flex justify-content-end align-items-center">
    ...
    <a class="mr-2" href="{{ route('provideraddress.create',['id' => $provideraddress->id]) }}" title="{{ __('messages.update_form_title',['form' => __('messages.provider_address') ]) }}"><i class="fas fa-pen text-primary"></i></a>
    @endif
