                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            {{ Form::select('package_type', ['single' => __('messages.single'), 'multiple' => __('messages.multiple')], old('package_type'), ['class' => 'form-control ','id' => 'package_type']) }}
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            {{ Form::label('name', __('messages.select_name',[ 'select' => __('messages.service') ]),['class'=>'form-control-label'],false) }}
                            <br />
